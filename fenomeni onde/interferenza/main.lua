...
local ostacolo = {}
ostacolo[1] = {fw*3/5, 0, 6, fh/2-9}
ostacolo[2] = {fw*3/5, fh/2-3, 6, 6}
ostacolo[3] = {fw*3/5, fh/2+9, 6, fh}
...
function love.draw()
	...
	for i = 1, calculationsPerFrame do
		...
		love.graphics.setShader()
		love.graphics.setCanvas(oz)
		for i, o in ipairs(ostacolo) do
			love.graphics.rectangle("fill", o[1], o[2], o[3], o[4])
		end
	...
	love.graphics.setCanvas()
	for i, o in ipairs(ostacolo) do
		love.graphics.rectangle("fill", o[1]*sw/fw, o[2]*sw/fw, o[3]*sw/fw, o[4]*sw/fw)
	end
	love.graphics.setColor(1, 1, 1)
